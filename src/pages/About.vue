        ...
        <v-col md="8" cols="12">
          <v-card color="accent lighten-2">
            ...
            <v-card-text class="headline">
              <p>นาย ซูลตอน แวกะจิ</p>
              <p>รหัสนึกศึกษา : 6110110107</p>
              <p>ที่อยู่ : 60 ถ.ท่าเสด็จ ต.ตะลุบัน อ.สายบุรี จ.ปัตตานี 64110</p>
              <p>ความฝัน : วิศวกกรมซอฟเเวร์</p>
              <p>อาชีพในฝัน : Full stack developer</p>
            </v-card-text>
          </v-card>
        </v-col>
      </v-row>
